    ...
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('employees.update', $employee) }}">
            ...
            <div class="form-group">
                ...
                <input name="first_name" value="{{ $employee->first_name }}" class="form-input">
            </div>

            <div class="form-group">
                <label>Last Name</label>
                <input name="last_name" value="{{ $employee->last_name }}" class="form-input">
            </div>

            <div class="form-group">
                <label>Email</label>
                <input name="email" id="email" value="{{ $employee->email }}" class="form-input">
            ...
            <div class="form-group">
                ...
                <div id="selectedSkills" class="skills-container">
            ...
            <button type="submit" id="employeeSubmitBtn" class="btn-submit">Update</button>
        </form>
    </div>
